...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://talentprofilet.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://talentid.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
