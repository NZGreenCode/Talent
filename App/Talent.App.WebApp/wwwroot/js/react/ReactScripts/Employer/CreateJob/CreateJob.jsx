...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? 'https://talentlist.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'https://talentlist.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        var cookies = Cookies.get('talentAuthToken');   
        $.ajax({
            url: 'https://talentlist.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
