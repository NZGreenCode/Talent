...
export class Images extends React.Component {
    ...
    loadImages(Id) {
        ...
        $.ajax({
            url: 'https://talentprofilet.azurewebsites.net/profile/profile/getEmployerProfileImage/?id=' + Id,
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employerProfile.length > 0) {
                    for (var i = 0; i < res.employerProfile.length; i++) {
                        imageSrcArr.push("https://talentprofilet.azurewebsites.net/profile/profile/getEmployerProfileImages/?Id=" + res.employerProfile[i].fileName);
    ...
    fileUploadHandler(Id) {
        ...
        $.ajax({
            url: 'https://talentprofilet.azurewebsites.net/profile/profile/addEmployerProfileImages',
            headers: {
                'Authorization': 'Bearer ' + cookies
            },
            type: "POST",
