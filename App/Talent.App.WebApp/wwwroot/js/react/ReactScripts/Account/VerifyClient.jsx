...
export default class VerifyClient extends React.Component {
    ...
    checkToken(recruiterEmail, clientEmail, resetPasswordToken) {
        ...
        let url = `https://talentid.azurewebsites.net/authentication/authentication/verifyClientToken?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentid.azurewebsites.net/authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
