...
export default class UserAccountSetting extends React.Component {
    ...
    save(e, field) {
        ...
        if (field == "name") {            
            $.ajax({
                url: 'https://talentid.azurewebsites.net/authentication/authentication/changeUserName?userName=' + this.state.userName,
                type: 'POST',
                headers: {
        ...
        if (field == "password") {
            ...
            $.ajax({
                url: 'https://talentid.azurewebsites.net/authentication/authentication/changePassword',
                type: "POST",
        ...
        if (field == "deactivate") {
            $.ajax({
                url: 'https://talentid.azurewebsites.net/authentication/authentication/deactivateAccount',
                type: "POST",
                headers: {
                    'Authorization': 'Bearer ' + cookies,
                    'Content-Type': 'application/json; charset=utf-8'
    ...
    getUserRole() {
        const cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentid.azurewebsites.net/authentication/authentication/getAccountSettingInfo',
            type: 'GET',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json; charset=utf-8'
